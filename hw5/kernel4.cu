...
void hostFE (float upperX, float upperY, float lowerX, float lowerY, int* img, int resX, int resY, int maxIterations)
{
    ...
    int *output_host;
    cudaHostAlloc((void **)&output_host,size,cudaHostAllocDefault);
    ...
    mandelKernel<<<numBlocks,threadsPerBlock>>>(stepX,stepY,lowerX,lowerY,output_host,resX,resY,maxIterations);
